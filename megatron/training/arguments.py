...
def _add_moe_args(parser):
    ...
    group.add_argument('--freeze-moe-router', action='store_true', default=False,
                       help='Freeze MoE router weights (requires_grad=False) to stabilize MoE RL '
                            'training / reduce logprob error. When set, the model is wrapped with '
                            'MoEFloat16Module so router expert_bias stays float32. Companion settings '
                            'often used with this flag: --moe-router-bias-update-rate 0.0 and '
